...
§
The ONLY piece still on Hostinger shared hosting is the marketing site movevn.com (WordPress), slated to migrate onto the same VPS (Andy 2026-08-05, not yet scheduled). Until then movevn.com lives on Hostinger; id.movevn.com lives on the VPS — don't conflate the two.
§
