...
§
The ONLY piece still on Hostinger shared hosting is the marketing site movevn.com (WordPress). It is slated to migrate onto the same VPS — Andy's decision (2026-08-05), NOT yet scheduled. Until then, movevn.com lives on Hostinger; the platform (id.movevn.com) lives on the VPS. Don't conflate the two when answering hosting questions.
§
