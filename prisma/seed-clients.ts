...
const CLIENTS = [
  ...
  // repoPath fixed 2026-08-05 (Spec I, I-9): the old
  // ~/PhpstormProjects/anhnguantoan has a .git and .idea and ZERO project
  // files, so the Claude Code offload and the File Center both pointed at
  // nothing. The canonical repo is on the DATA2 external drive — it must be
  // mounted for the offload to resolve.
  { slug: "safe-english",          name: "Anh Ngu An Toan",      type: "edtech",    hermesProfile: "safe-english", status: "unconfigured", accent: "#f87171", description: "Vietnamese TOEIC-prep platform — anhnguantoan.com (WordPress + MasterStudy LMS).", repoPath: "/Volumes/DATA2/1-Development/Anh Ngu An Toan/anhnguantoan-dev" },
