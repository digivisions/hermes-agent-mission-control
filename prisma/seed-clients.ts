...
const CLIENTS = [
  { slug: "klaily",                name: "Klaily",               type: "ecommerce", hermesProfile: "klaily",       status: "active",       accent: "#34d399", description: "Botanical earrings store + custom OS 2.0 theme; family business with sister on Palmstreet." },
  ...
  { slug: "safe-english",          name: "Anh Ngu An Toan",      type: "edtech",    hermesProfile: "safe-english", status: "unconfigured", accent: "#f87171", description: "Safety English learning platform." },
